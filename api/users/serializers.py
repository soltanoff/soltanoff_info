...
class UserSerializer(serializers.HyperlinkedModelSerializer):
    ...
    group_names = serializers.HyperlinkedIdentityField(view_name='user-group-names', read_only=True)

    class Meta:
        model = User
        fields = ('url', 'username', 'email', 'groups', 'group_names', 'is_staff', 'is_superuser')
